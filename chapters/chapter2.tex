...
$\mathbf{a}^{(l)}$. Note that part of these derivatives, namely $\sigma'$, can
be computed analytically
%taking the derivative of the activation function of choice
(see e.g.~\autoref{eq:logistic_derivative} and \autoref{eq:relu_derivative})
and applied directly in the formula. Interestingly, when $\sigma$ is a function
applied elementwise (e.g.\ in the case of logistic, tanh and ReLU activations),
