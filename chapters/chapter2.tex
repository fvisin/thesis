...
weaker than $C_{t-1}$ and some others are potentially zeroed out.
...
\noindent the memory resulting from the transformations due to the forget and
...
written. The modified state update equation is
